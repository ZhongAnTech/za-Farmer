...
public class BySelector {
     ...
     * 自定义检查规则
     * by 孙建平
     * @param iCheckCriteria
     * @return
     */
    public BySelector setCustomCheckCriteria(ICheckCriteria iCheckCriteria) {
        checkNotNull(iCheckCriteria, "checkCriteria cannot be null");
        this.iCheckCriteria = iCheckCriteria;
        return this;
    }
