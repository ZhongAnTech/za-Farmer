...
public class UiDevice implements Searchable {
    ...
    /**
     * 返回第一个元素，只查询一次不触发watch.
     * code by 孙建平
     */
    public UiObject2 findObjectOnce(BySelector selector) {
        AccessibilityNodeInfo node = ByMatcher.findMatchOnce(this, selector, getWindowRoots());
        return node != null ? new UiObject2(this, selector, node) : null;
    }
    ...
    public Bitmap takeScreenshot() {
        return getAutomatorBridge().takeScreenshot();
    }
    ...
    AccessibilityNodeInfo[] getWindowRoots() {
        ...
        //保持和 uiautomatorviewer 看到一样多的元素
